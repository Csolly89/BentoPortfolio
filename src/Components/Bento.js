    ...
    return (
        <>
            <ul className=" grid grid-cols-4 grid-rows-5 gap-20 m-12 px-12 pb-12 h-[85vh]">
                {/* profile picture */}
                <li className="bg-[#424b54] transform shadow-xl shadow-textwhite hover:shadow-[#149911] hover:scale-105 rounded-2xl row-span-3 col-span-2"><div className="h-24 text-center mt-48 ">Profile Picture</div></li>
                {/* social icons */}
                <li className="bg-invisible transform  shadow-lg shadow-secondary hover:shadow-[#149911] hover:scale-105 rounded-2xl col-span-2"><div className="h-24 text-center ">Social Icons</div></li>
                    <Link to={'/about'} >
                        {/* about link */}
                ...
                {/* profile 2 */}
                <li className="bg-[#424b54] transform shadow-xl shadow-textwhite hover:shadow-[#149911] hover:scale-105 rounded-2xl col-span-1 row-span-2"><div className="h-24 text-center ">Profile 2</div></li>
                {/* logo */}
