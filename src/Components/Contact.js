        ...
        <img className="w-full h-[100vh] top-0 fixed z-[-10]  object-fill" src={green} alt="gradient background" />
            <div className="mb-12">
                <div  className="px-4 mx-auto sm:px-6 lg:px-8 mt-20">
                    ...
                    <div className="max-w-6xl mx-auto mt-5 overflow-hidden bg-gradient-to-tr from-charcoal to-slate-500  rounded-md shadow-md lg:mt-8 text-textwhite">
                        <div className="grid grid-cols-1 lg:grid-cols-5 font-Prompt">
